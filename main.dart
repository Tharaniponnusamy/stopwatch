...
class MyStopwatchApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Stopwatch',
      theme: ThemeData(
        primarySwatch: Color.fromARGB(255, 86, 212, 75),
      ),
...
class _StopwatchScreenState extends State<StopwatchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Stopwatch',style: TextStyle(color: const Color.fromARGB(255, 231, 72, 72)),),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text('Pause'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color.fromARGB(255, 188, 58, 228), // Add a color for each button
                  ),
                ),
                SizedBox(width: 20),
                ElevatedButton(
                  ...
                  child: Text('Reset'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color.fromARGB(255, 187, 167, 166), // Add a color for each button
                  ),
                ),
              ],
            ),
